...
import {
  ...
  Ruler, // For justify alignment if a specific icon isn't available
} from 'lucide-react';
...
export default function ChooseUsEditorPage() { // Renamed to ChooseUsEditorPage for consistency
  ...
  const [form, setForm] = useState({
    ...
    pointTitleSize: '1.125rem', // text-lg equivalent
    pointTitleWeight: '600',    // font-semibold equivalent
    pointTitleAlign: 'center',
    pointDescSize: '0.875rem',  // text-sm equivalent
  ...
  const commonColorInputClasses = "h-10 w-full border border-gray-300 rounded-md p-1 cursor-pointer";
  const sectionHeaderClasses = "text-xl font-bold text-gray-800 mb-4 flex items-center gap-2";
  const subSectionHeaderClasses = "text-lg font-semibold text-gray-700 mb-3 flex items-center gap-2";
