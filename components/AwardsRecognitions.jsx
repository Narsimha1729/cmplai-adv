          ...
          {track.map((award, index) => (
            ...
            >
              <div className="relative h-52 sm:h-56 w-full bg-gray-100 overflow-hidden">
                ...
                {award.type === "article" && (
                  <span className="absolute top-3 left-3 rounded-full bg-white/95 px-3 py-1 text-xs font-semibold text-teal-700 shadow-sm">
                    Press
                  </span>
                )}
              </div>
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                ...
                <p className="text-gray-600 text-sm sm:text-[15px] leading-relaxed whitespace-normal flex-1">
                  {award.description}
                </p>
                {award.type === "article" && award.href && (
                  <a
                    ...
                    className="mt-4 inline-flex items-center text-sm font-semibold text-teal-600 hover:text-teal-800 transition-colors"
                  >
